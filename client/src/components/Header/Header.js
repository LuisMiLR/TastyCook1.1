  ...
  return (
    <header className={`${styles.Header} d-flex flex-row align-items-center`}>
      ...
      <ul className={styles.headerList}>
        ...
        {token ?
        <NavLink to="/Profile">
        <button className=" mr-15 btn btn-reverse-primary"> <i className="fa-solid fa-user mr-5"></i>
...
//           </ul>
//           <i onClick={() => setShowMenu(true)} className={`fa-solid fa-bars fa-2x ${styles.headerXs} `}></i>
//           {showMenu && (  <>  <div onClick={() => setShowMenu(false)} className="calc"></div> <HeaderMenu /> </>)}
//       </header>
//   );
