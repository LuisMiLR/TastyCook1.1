...
le Backend est réalisé avec Node.js, le framework Express.js et MySql pour la relation avec la Base de donnée.  

la barre de recherche détecte les première lettre saisie pour ensuite affiner la recherche 
Il s'agit de la premier version 1.1 du projet d'autre amélioration sont prévu
